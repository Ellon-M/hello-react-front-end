...
**Hello React Front End** is a react app that displays a random greeting from a rails API endpoint request.
...
run git clone `https://github.com/Ellon-M/hello-react-frontend.git`
